...
import AsideFiltroCategoria from "./filtro.js"
...
const navTamanho = document.querySelector('#nav-tamanho')
const buttonShowTamanho = document.querySelector('#button-show-tamanho')
const buttonHideTamanho = document.querySelector('#button-hide-tamanho')

const navFaixaPreco = document.querySelector('#nav-faixa-preco')
const buttonShowFaixaPreco = document.querySelector('#button-show-faixa')
const buttonHideFaixaPreco = document.querySelector('#button-hide-faixa')


const EventFiltro = AsideFiltroCategoria({
  buttonHide,
  buttonShow,
  navCategoria,
  navTamanho,
...
buttonShow.addEventListener('click', EventFiltro.TogleAsideCategoria)
buttonHide.addEventListener('click', EventFiltro.TogleAsideCategoria)
buttonShowTamanho.addEventListener('click', EventFiltro.TogleAsideTamanho)
buttonHideTamanho.addEventListener('click', EventFiltro.TogleAsideTamanho)
buttonShowFaixaPreco.addEventListener('click', EventFiltro.TogleAsideFaixaPreco)
buttonHideFaixaPreco.addEventListener('click', EventFiltro.TogleAsideFaixaPreco)
